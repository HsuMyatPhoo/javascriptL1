var slides = document.getElementsByClassName('carousel-item');//HTML Collection
var dots = document.querySelectorAll('.dot');//NodeList
...
//slide 	0		   1		2
//curslide 1-1=0	 2-1=1	 3-1=2

//remove ka classList nk twel use ya tl
